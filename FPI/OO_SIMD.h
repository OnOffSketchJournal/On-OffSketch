...
template<>
struct OPI_OPT<uint32_t,int32_t,8>::Bucket{
    uint32_t items[8];
    int32_t counters[8];
...
template<>
void OPI_OPT<uint32_t,int32_t,8>::Insert(const uint32_t item, const int32_t window){
...
template<>
struct OPI_OPT<uint64_t,int32_t,8>::Bucket{
    uint64_t items[8];
    int32_t counters[8];
...
template<>
void OPI_OPT<uint64_t,int32_t,8>::Insert(const uint64_t item, const int32_t window){
    uint32_t pos = hash(item) % length;
...
template<>
struct OPI_OPT<uint32_t,int32_t,32>::Bucket{
    uint32_t items[32];
    int32_t counters[32];
...
template<>
void OPI_OPT<uint32_t,int32_t,32>::Insert(const uint32_t item, const int32_t window){
    uint32_t pos = hash(item) % length;
    __m256i vec = _mm256_set1_epi32(item);
...
template<>
struct OPI_OPT<uint64_t,int32_t,32>::Bucket{
    uint64_t items[32];
    int32_t counters[32];
...
template<>
void OPI_OPT<uint64_t,int32_t,32>::Insert(const uint64_t item, const int32_t window){
    uint32_t pos = hash(item) % length;
    __m256i vec = _mm256_set1_epi64x(item);
